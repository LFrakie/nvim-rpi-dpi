...
imap <C-s><C-s> <Esc>:! git add . <Enter> :! git commit -m "/as-m" && git push -u origin as:master <Enter>

nmap <C-s><C-s> :! git add . <Enter> :! git commit -m "/as-m" && git push -u origin as:master <Enter>
